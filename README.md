...
Light-Scan Pro is the commercial service tier designed for organizations that require dedicated support, early access, and enterprise‑grade reliability. Subscribers benefit from 24/7 technical support, priority bug fixes, on‑demand feature development, and exclusive early access to new releases 1 month or even more then that before the general public — giving them a critical edge in fast‑paced security environments. Light-Scan Pro is available for $999/year for the entire organization or a 119$/month for the entire organization as well (covering all machines and users under a single subscription), with a clear commitment to transparency and fairness: while we reserve the right to adjust pricing in the future, any price changes will not apply to existing enterprise customers or to any users who subscribed prior to the change. This ensures that early adopters and long‑term partners are protected and can continue to rely on Light‑Scan Pro at the terms they originally agreed to.

For all inquiries regarding Light-Scan Pro subscriptions, enterprise licensing, custom script development, or managed scanning services, please reach out directly to me at adamboulaaz92@gmail.com. As a solo developer, I personally handle all communications, support requests, and custom development projects — ensuring you get direct, fast, and high-quality responses without any layers of bureaucracy. Whether you're interested in purchasing a Pro subscription, need assistance with compliance requirements, or want to discuss a custom LSSE script or feature, I'm here to help. I aim to respond to all inquiries within 24 hours, with priority response times for Pro subscribers. For bug reports, feature requests, or general questions about the open-source toolkit, I encourage you to open an issue on our GitHub repository or join our community Discord server. However, for any commercial or service-related matters, emailing me directly is the fastest and most reliable way to get in touch.
